  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-center">Kết quả nhận diện</DialogTitle>
        </DialogHeader>

        <div className="flex flex-col items-center space-y-4">
          {/* Image preview */}
          <div className="relative w-full max-h-[300px] overflow-hidden rounded-lg">
            <img src={imageData || "/placeholder.svg"} alt="Captured" className="w-full h-auto object-contain" />
          </div>
          ...
          {!isLoading && result && (
            <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 w-full text-center">
              <h3 className="text-lg font-medium text-teal-800">Kết quả nhận diện</h3>
          ...
          {!isLoading && error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 w-full text-center">
              <h3 className="text-lg font-medium text-red-800">Không thể nhận diện</h3>
